  ...
  const handleRegister = async () => {
    try {
      ...
      Alert.alert(
        ...
        'The instructor has been successfully registered.',
        [
          {
            text: 'OK',
            onPress: () => router.back(),
      ...
      if (error instanceof Error) {
        ...
        } else if (error.message.includes('instructorId')) {
          errorMessage = 'This instructor ID is already registered';
        } else if (error.message.includes('fullName')) {
          errorMessage = 'An instructor with this name is already registered';
        } else {
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={text => setFormData({ ...formData, instructorId: text })}
            />
          </View>
